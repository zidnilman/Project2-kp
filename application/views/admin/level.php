...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#newLevelModal">Tambah Level Baru</a>
                ...
                <tbody>
                    ...
                    <?php foreach ($level as $l) : ?>
                        <tr>
                            ...
                            <td><?= $l['level']; ?></td>
                            <td>
                                <a href="<?= base_url('admin/levelaccess/') . $l['id']; ?>" class=" badge badge-pill badge-warning">akses</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newLevelModalLabel">Tambah Level Baru</h5>
